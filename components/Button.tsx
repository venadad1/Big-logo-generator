...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-white hover:bg-slate-50 text-slate-700 shadow-sm border border-slate-300 focus:ring-indigo-500",
    outline: "bg-transparent hover:bg-slate-100 text-slate-600 border border-slate-300 focus:ring-slate-500"
  };
